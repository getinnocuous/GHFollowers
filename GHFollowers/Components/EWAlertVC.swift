...
class EWAlertVC: UIViewController {
  
  let containerView = UIView()
  let titleLabel = EWTitleLabel(textAlign: .center, fontSize: 20)
  let messageLabel = EWBodyLabel(textAlign: .center)
  let actionButton = EWButton(backgroundColor: .systemPink, title: "OK")
